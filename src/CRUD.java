...
public class CRUD {
	...
	static String deleteTask(String filename, String remainingString, LastAction lastAction)
		...
		if (deleteVariableType.equalsIgnoreCase("floating")) {
			...
			if (Integer.valueOf(tempNumber) > floatingTasksList.size()) {
				FlexWindow.getTextArea().appendText(TASK_DOES_NOT_EXIST_MESSAGE +
				 "\n");
				FlexWindow.getTextArea().appendText("\n");
	...
	static String changeTaskVariable(String filename, String remainingCommandString, LastAction lastAction) throws IOException {
		...
		FlexWindow.getTextArea().appendText(CHANGED_MESSAGE + "\n");
		FlexWindow.getTextArea().appendText("\n");
	...
	static String addTask(String filename, String remainingCommandString, LastAction lastAction)
			...
			for (int w = 0; w < allTasksList.size(); w++) {
				if ((Checker.isEventTaskInput(allTasksList.get(w).getScheduleString())
					...
					if ((totalStartingTime > existingTotalStartingTime) && (totalStartingTime < existingTotalEndingTime)
						...
						FlexWindow.getTextArea().appendText(BLOCKED_MESSAGE +
						 "\n");
						FlexWindow.getTextArea().appendText("\n");
		...
		FlexWindow.getTextArea().appendText("The task " + "\"" + tempTask.getDisplayString() + "\"" + 
		" has been added." + "\n");
		FlexWindow.getTextArea().appendText("\n");
	...
	static String undo(String filename, LastAction lastAction)
		...
		if (lastAction.getPreviousAction() == null || lastAction.getPreviousTask() == null) {
			FlexWindow.getTextArea().appendText(NOTHING_TO_UNDO_MESSAGE + "\n");
			FlexWindow.getTextArea().appendText("\n");
	...
	static String markAsDone(String filename, String remainingCommandString, LastAction lastAction) throws IOException {
		...
		FlexWindow.getTextArea().appendText(MARKED_DONE_OR_NOT_DONE_MESSAGE +
		 "\n");
		FlexWindow.getTextArea().appendText("\n");
